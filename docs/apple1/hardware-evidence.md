...
一手资料核对日期：2026-09-11，范围为 Apple I 原始操作手册（1976）、三张原理图、MC6820 原厂数据表（1976）与 MC6821 原厂数据表（1985）的指定页。实现对应关系于 2026-09-14 按当前代码同步，区分已关闭缺口、剩余差异和模拟约定；本次文档更新不改动硬件模型或原始证据。
